 ...
 * ## Storage Location
 *
 * Recordings are saved to: `{cwd}/apps/simultan-dolmetscher/src/assets/recordings/`
 *
 * ## Usage Example
 *
 * ```typescript
...
export class AudioRecordingService {
   ...
   * @private
   */
  private readonly recordingsDirectory = path.join(process.cwd(), 'apps/simultan-dolmetscher/src/assets/recordings');
